...
- 47ce9ac: ## Valko-UI Components

  ### Components

  - Added the new `Rating` component with support for:
    - Single and half ratings.
    - Hover previews and animated selection feedback.
    - Custom icons, colors, sizes, disabled, and readonly states.
    - Accessible ARIA roles and screen reader support.

  ### Exports

  - **valko-ui.css:**
    - Added the reusable `pop` animation, available for use across components.

  ### Types

  - Added `Rating` component types.

  ### Tests

  - Added unit tests covering rendering, interaction, accessibility, and selection behavior for the `Rating` component.

  ## Valko-UI Docs

  - Added documentation and examples for the `Rating` component.

### Patch Changes

- Updated dependencies [47ce9ac]
  - @valko-ui/components@0.7.0
...
- 305d717: ## Valko-UI Docs:

  ### Utils

  - Removed `generateStyles`.

  ### Pages

  - Updated all documentation pages to pass style slot objects directly, instead of using the removed utility.

- 2e0391b: ## Valko-UI Docs
  ...
  - The menu now automatically scrolls to the active item on page reload.
  - Scrolls to the active item when navigating between pages.
  - Scrolls to the active item when opening the mobile menu.

- 4fa44ec: ## Valko-UI Docs
...
- Updated dependencies [36e6d8b]
- Updated dependencies [bf09255]
- Updated dependencies [5ef90af]
- Updated dependencies [1c52a30]
- Updated dependencies [e1d6080]
- Updated dependencies [e046952]
- Updated dependencies [2469c63]
- Updated dependencies [6f57de5]
  - @valko-ui/components@0.6.0
  - @valko-ui/eslint-config@0.3.0
...
- Updated dependencies [21da4e4]
  - @valko-ui/components@0.5.3
