...
<template>
  <div class="max-w-screen-xl mx-auto mt-10 bg-surface-container flex rounded-lg shadow">
    <aside class="w-1/5 border-r-2 border-outlined">
      <vk-menu
        :items="menuItems"
        :active="activeItem"
        floating
    ...
    <main class="w-4/5 p-6">
      ...
      >
        ...
        <vk-checkbox
          v-model="form.checkboxs.profile"
          label="Make my profile public"
        />
        <vk-checkbox
          v-model="form.checkboxs.search"
          label="Allow search engines to index my profile"
        />
        <vk-button class="mt-auto w-1/5">
          Save Changes
        </vk-button>
      </div>

      <div
        v-if="activeItem === 'notifications'"
        class="flex flex-col gap-4 h-full"
      >
        ...
        <vk-checkbox
          v-model="form.checkboxs.email"
          label="Email Notifications"
        />
        <vk-checkbox
          v-model="form.checkboxs.push"
          label="Push Notifications"
        />
        <vk-checkbox
          v-model="form.checkboxs.sms"
      ...
      >
        ...
        />
        <vk-checkbox
          v-model="form.checkboxs.compact"
